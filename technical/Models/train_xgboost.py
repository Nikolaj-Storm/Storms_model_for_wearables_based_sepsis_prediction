...
#
#  PURPOSE
#    Trains a single XGBoost classifier on the V12 1-hour engineered training
#    set for the 6-hour sepsis target and serialises the fitted model to disk.
...
#    Output model path  -  saved_models/xgboost.joblib
#
#  REQUIRES: xgboost, joblib, pandas
# ============================================================================
...
model = XGBClassifier(n_estimators=100, max_depth=6, learning_rate=0.1, random_state=42, scale_pos_weight=10, n_jobs=-1)  # EDIT: XGBoost hyperparameters
model.fit(X, y)

print("Saving model...")
os.makedirs('saved_models', exist_ok=True)
joblib.dump(model, 'saved_models/xgboost.joblib')  # EDIT: output model path
